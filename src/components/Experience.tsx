...
const experiences = [
  {
    ...
    date: '2026 – Present',
    desc: 'Architected and built Atuwa, a full-stack e-commerce platform for Sri Lankan medicinal products. Designed and implemented the database, developed secure authentication and order management features, integrated online payments, and built a responsive React frontend focused on a smooth shopping experience.',
    tags: ['Responsive Web Design', 'UI Design', 'Mobile-First Design'],
    glow: 'rgba(139,92,246,0.4)',
  },
  {
    icon: <FaGraduationCap/>,
    title: 'BEng graduate Developer',
    company: ' IIC University of Technology · Cambodia',
    date: '2022 – 2026',
